...
- Custom content models and "contexts" in the "series" and "teams" apps
...
- Example of using the Wagtail "snippets" system to represent series categories, countries and ingredients
- Example of a custom "Galleries" feature that pulls in images used in other content types in the system
- Example of creating ManyToMany relationships via the Ingredients feature on SeriesPage
- Lots more
...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/wagtail/scoresnow/)
...
```bash
git clone https://github.com/wagtail/scoresnow.git
cd scoresnow
vagrant up
vagrant ssh
...
installed, run:
    ...
    mkvirtualenv wagtailscoresnow
    python --version

Confirm that this is showing a compatible version of Python 3.x. If not, and you have multiple versions of Python installed on your system, you may need to specify the appropriate version when creating the virtualenv:

    deactivate
    rmvirtualenv wagtailscoresnow
    mkvirtualenv wagtailscoresnow --python=python3.9
    python --version
...
to help with this. It reads environment variables located in a file name `.env` in the top level directory of the project. The only variable we need to start is `DJANGO_SETTINGS_MODULE`:
    ...
    $ cp scoresnow/settings/local.py.example scoresnow/settings/local.py
    $ echo "DJANGO_SETTINGS_MODULE=scoresnow.settings.local" > .env
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/wagtail/scoresnow)
...
If you're a Python or Django developer, fork the repo and get stuck in! If you'd like to get involved you may find our [contributing guidelines](https://github.com/wagtail/scoresnow/blob/master/contributing.md) a useful read.
...
`./manage.py dumpdata --natural-foreign --indent 2 -e auth.permission -e contenttypes -e wagtailcore.GroupCollectionPermission -e wagtailimages.filter -e wagtailcore.pagerevision -e wagtailimages.rendition -e sessions > scoresnow/base/fixtures/scoresnow.json`
...
Make a pull request to https://github.com/wagtail/scoresnow
