...
from scoresnow.base.models import FooterText
...
@register.inclusion_tag("tags/seriescrumbs.html", takes_context=True)
def seriescrumbs(context):
    self = context.get("self")
    if self is None or self.depth <= 2:
        # When on the home page, displaying seriescrumbs is irrelevant.
        ancestors = ()
    else:
