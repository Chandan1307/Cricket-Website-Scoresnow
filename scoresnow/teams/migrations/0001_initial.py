    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('closed', models.BooleanField(blank=True, help_text='Tick if team is closed on this day', verbose_name='Closed?')),
                ('team', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='hours_of_operation', to='teams.teamspage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
