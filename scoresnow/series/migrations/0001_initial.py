# Generated by Django 4.0.8 on 2022-10-17 07:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredients', modelcluster.fields.ParentalManyToManyField(blank=True, to='series.seriesingredient')),
                ('origin', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='series.country')),
                ('series_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='series.seriestype')),
            ],
            options={
                'abstract': False,
            },
